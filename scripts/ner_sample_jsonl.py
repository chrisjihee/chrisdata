...
def make_dev_set(
        ...
        output_file="data/GNER-N2/GNER-ZSE-validation-sampled.jsonl"
):
...
def make_test_set(
        ...
        output_file="data/GNER-N2/GNER-ZSE-test-sampled.jsonl"
):
...
def make_train_set(
        ...
        output_file="data/GNER-N2/pile-ner-sampled.jsonl"
):
