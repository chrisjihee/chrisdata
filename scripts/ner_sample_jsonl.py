...
def make_dev_set_for_ZSE(input_file, output_file):
    ...
    convert_to_hybrid_round_version(output_file=output_file, mr_input_file=None, sr_input_file=input_file)  # SR1400
...
def make_test_set_for_ZSE(input_file, output_file):
    ...
    convert_to_hybrid_round_version(output_file=output_file, mr_input_file=None, sr_input_file=input_file)  # SR6470
