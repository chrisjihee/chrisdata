...
def make_dev_set_for_ZSE(input_file, output_file):
    ...
    convert_to_hybrid_round_version(mr_input_file=dev_sampled_70, sr_input_file=dev_sampled_70)  # 870
    convert_to_hybrid_round_version(mr_input_file=dev_sampled_70, sr_input_file=dev_sampled_700)  # 1,500
    convert_to_hybrid_round_version(mr_input_file=dev_sampled_210, sr_input_file=dev_sampled_700)  # 3,100
    convert_to_hybrid_round_version(mr_input_file=dev_sampled_700, sr_input_file=dev_sampled_1400)  # 9,400
...
def make_test_set_for_ZSE(input_file, output_file):
    ...
    convert_to_hybrid_round_version(mr_input_file=test_sampled_70, sr_input_file=test_sampled_70)  # 870
    convert_to_hybrid_round_version(mr_input_file=test_sampled_70, sr_input_file=test_sampled_700)  # 1,500
    convert_to_hybrid_round_version(mr_input_file=test_sampled_210, sr_input_file=test_sampled_700)  # 3,100
    convert_to_hybrid_round_version(mr_input_file=test_sampled_700, sr_input_file=test_sampled_1400)  # 9,400


def make_train_set_for_ZSE(input_file, output_file):
    train_sampled_1000 = stratified_sample_jsonl(input_file=input_file, output_file=output_file,
                                                 min_num_word=10, max_num_word=80,
                                                 min_num_label=3, max_num_label=7,
                                                 min_num_samples=3, max_num_samples=10)  # 902
    train_sampled_20000 = stratified_sample_jsonl(input_file=input_file, output_file=output_file,
                                                  min_num_word=10, max_num_word=100,
                                                  min_num_label=3, max_num_label=7,
                                                  min_num_samples=3, max_num_samples=10)  # 19,988
    train_sampled_30000 = stratified_sample_jsonl(input_file=input_file,
                                                  output_file=output_file,
                                                  min_num_word=10, max_num_word=100,
                                                  min_num_label=3, max_num_label=10,
                                                  min_num_samples=3, max_num_samples=10)  # 30,129
    train_sampled_40000 = stratified_sample_jsonl(input_file=input_file, output_file=output_file,
                                                  min_num_word=10, max_num_word=100,
                                                  min_num_label=3, max_num_label=20,
                                                  min_num_samples=3, max_num_samples=10)  # 39,852
    convert_to_hybrid_round_version(sr_input_file=input_file, mr_inst_file=None)  # 103,814
    convert_to_hybrid_round_version(mr_input_file=train_sampled_1000, sr_input_file=train_sampled_1000)  # 4,244
    convert_to_hybrid_round_version(mr_input_file=train_sampled_20000, sr_input_file=input_file)  # 207,842
    convert_to_hybrid_round_version(mr_input_file=train_sampled_30000, sr_input_file=input_file)  # 298,291
    convert_to_hybrid_round_version(mr_input_file=train_sampled_40000, sr_input_file=input_file)  # 433,594
